...
- deprecate
  [`fread_colmatch()`](https://drieslab.github.io/GiottoUtils/reference/read_colmatch.md)
  in favor of
  [`read_colmatch()`](https://drieslab.github.io/GiottoUtils/reference/read_colmatch.md)
...
- [`package_check()`](https://drieslab.github.io/GiottoUtils/reference/package_check.md)
...
- [`lapply_flex()`](https://drieslab.github.io/GiottoUtils/reference/lapply_flex.md)
...
- Rename `guard_against_notgiotto()` to
  [`assert_giotto()`](https://drieslab.github.io/GiottoUtils/reference/g_assert.md)
...
- Rename `assert_DT()` to
  [`assert_dt()`](https://drieslab.github.io/GiottoUtils/reference/g_assert.md)
